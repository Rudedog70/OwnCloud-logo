...
into the directory where the scripts to compile the dynamic
MOTD are located. In Ubuntu 14.04 it's /etc/update-motd.d/.
Be sure the correct permissions and ownership are set and the
